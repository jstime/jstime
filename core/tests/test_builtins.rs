...
mod tests {
    ...
    fn import_meta_url_is_file_url() {
        ...
        std::fs::write(&test_file, 
            "export const check = import.meta.url.startsWith('file://');").unwrap();
    ...
    fn import_meta_url_contains_filename() {
        ...
        std::fs::write(&test_file, 
            "export const check = import.meta.url.includes('test_unique_filename_12345.js');").unwrap();
    ...
    fn import_meta_url_different_per_module() {
        ...
        std::fs::write(&test_file1, &format!(
